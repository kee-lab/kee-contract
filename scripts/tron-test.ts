...
async function main() {
    ...
    // let contract_instance = await tronWeb.contract().at("TMMBsjSVaWXzzTgBnunkGatoKgi57wevyg");
    // let result = await contract_instance.claimProfit("TEeeCkMA3gXekaKRPYMhhEwUkve6YBCTVy", 1000, 5000000, 300).send({
    //     feeLimit: 4_00_000_000,
    //     callValue: 0,
    //     shouldPollResponse: true
    // });
    ...
    let errorInfo = tronWeb.toAscii("15636c61696d20616d6f756e7420746f6f2068696768");
